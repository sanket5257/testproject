...
const Page = () => {
  ...
  const [appliedJobs, setAppliedJobs] = useState([
    { id: 1, title: "Frontend Developer", company: "Tech Corp", location: "Remote", applieddate: "Applied on January 30, 2025",companylogo:"./twitter.png" },
    { id: 2, title: "Backend Engineer", company: "Code Labs", location: "New York", applieddate: "Applied on January 30, 2025",companylogo:"./google.svg" },
    { id: 3, title: "UI/UX Designer", company: "Design Studio", location: "San Francisco", applieddate: "Applied on January 30, 2025",companylogo:"./apple.png" }
  ]);
  ...
  return (
   ...
   <div className="flex flex-col font-Montserrat md:flex-row w-full min-h-screen pt-16 bg-white text-black">
        ...
        <h2 className="text-4xl font-bold mb-4">My Applications</h2>
          ...
          <h3 className='font-Montserrat mb-4 text-[#4F7594]'>You can track the jobs you've applied to here</h3>
