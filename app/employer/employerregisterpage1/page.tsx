  ...
  return (
    ...
    <div className=" bg-white md:flex md:pt-[15vh] pt-[10vh]">
      <div
        ...
        <img src="../employerimg/signupbg.jpeg" alt="" />
      </div> 
      <div className="flex md:w-1/2 justify-center md:px-20 px-4 items-center bg-white">
        <form method='post' className="bg-white ">
      <h1 className="font-bold text-center font-Montserrat md:text-3xl text-xl text-blue-800 mb-1">Employer Register</h1>
      ...
      <div className=" mb-2  font-Montserrat">
        <label htmlFor="whatsapp number" className="text-black text-lg font-medium">Designation</label>
        <input
      ...
      {/*Company Name */}
      <div className="mb-2 font-Montserrat">
        <label htmlFor="email" className="text-black text-lg font-medium">Company Name</label>
        <input
            className="border-2 border-gray-400 mt-1 py-2 px-3 rounded-xl w-full text-black"
            type="text"
            id="Company Name"
      ...
      <div className="mb-2 font-Montserrat">
      <div className="">
      <label htmlFor="email" className="text-black text-lg font-medium">Company Domain</label>
      ...
      <div className="mb-2 font-Montserrat">
        <label htmlFor="email" className="text-black text-lg font-medium">Company Details</label>
        <input
            className="border-2 border-gray-400 mt-1 py-2 px-3 rounded-xl w-full text-black"
            type="text"
            id="Company Details"
    ...
    {/* About Company */}
    <div className="mb-2 font-Montserrat">
        <label htmlFor="email" className="text-black text-lg font-medium">About Company</label>
        <input
            className="border-2 border-gray-400 mt-1 py-2 px-3 rounded-xl w-full text-black"
            type="text"
            id="About Company"
      ...
      {/* No. of employee*/}
    <div className="mb-2 font-Montserrat">
        <label htmlFor="email" className="text-black text-lg font-medium">No. of employee</label>
        <input
            className="border-2 border-gray-400 mt-1 py-2 px-3 rounded-xl w-full text-black"
            type="number"
            id="No. of employee"
