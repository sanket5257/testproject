...
<div className='flex justify-between gap-4 items-center'>
    <div>
    <div className=" mb-2 font-Montserrat">
    <label htmlFor="password" className="text-black text-lg font-medium">GST no. and document</label>
    <input
        className="border-2 border-gray-400 mt-1 py-2 px-3 rounded-xl w-full text-black"
        type="number"
  ...
  <div className=" mb-2 font-Montserrat">
    <label htmlFor="password" className="text-black text-lg font-medium">Website link</label>
    <input
        className="border-2 border-gray-400 mt-1 py-2 px-3 rounded-xl w-full text-black"
        type="number"
        id="Website link"
