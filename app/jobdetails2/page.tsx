  ...
  return (
    <div className='bg-white h-screen font-Montserrat text-black'>
      ...
      <div className="h-full md:w-[70vw] w-[90vw]">
            {appliedJobs.map((job) => (
              <div key={job.id} className="p-4 flex justify-between md:w-[70vw] items-center bg-[#F7FAFA] border shadow-lg rounded-lg">
             <div className='flex items-center justify-center'>
             <img className='size-20 p-4' src={job.companylogo} alt="" />
                <div>
                <h3 className="text-xl text-[#004C99] font-semibold">{job.title}</h3>
          ...
          <div className='md:w-[70vw] w-[90vw] border p-9 rounded-2xl'>
            <div className='md:w-[42vw] flex justify-center items-start flex-col gap-4'>
                <div className=''>
                     <button className='bg-[#787878] mr-4 text-white p-2 rounded-xl'>Job Details</button>

                    <button className='bg-white text-black border p-2 rounded-xl'>Company Details</button>
                </div>
            ...
            <h3 className='text-[#787878]'> Health insurance, 401(k) matching, flexible work hours, opportunities for professional development.</h3>
