        ...
        <div className="flex md:w-1/2 justify-center md:px-20 px-4 items-center bg-white">
          <form method="post" onSubmit={handleOnSubmit} className="bg-white ">
            ...
            <div className=" mb-2 flex justify-between  items-center  font-Montserrat gap-10 ">
              <div className="">
                <label htmlFor="Age" className="text-black text-lg font-medium">
                  Age
                </label>
                <input
              ...
              <div className="">
                ...
                <select
                  id="options"
                  name="Select Gender"
                  className="border-2 placeholder:text-sm  mt-1 h-14 rounded-2xl md:w-[18vw] border-gray-400 text-gray-400"
                >
