...
const Page = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen pb-10  font-Montserrat md:flex-row w-full pt-16 bg-white text-black">
        ...
        <div className="w-full md:w-3/4 md:p-18 p-6">
          ...
          <h3 className="font-Montserrat mb-4 text-[#4F7594] text-center md:text-start">
            Saved jobs—apply when youre ready
          </h3>
