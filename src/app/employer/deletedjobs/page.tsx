  ...
  return (
    <>
      ...
      <div className="flex flex-col font-Montserrat md:flex-row w-full min-h-screen pt-16 bg-white text-black">
        ...
        <div
          className={`fixed inset-0 h-[100vh] flex flex-col gap-4 items-start px-10 pt-10 rounded-2xl bg-white  border shadow-lg transition-transform transform ${
          ...
          <div className="mb-4 flex flex-col gap-2">
            ...
            <div className="flex gap-2 justify-center items-center flex-col">
              {["New to old", "Old to new", "A-Z", "Z-A"].map((type, index) => (
                <div
                  key={index}
                  className="flex gap-2  text-md justify-between  border w-full  text-gray-700 rounded-lg px-5 py-4 cursor-pointer "
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
            {appliedJobs.map((val, index) => {
              return (
                <div
                  key={index}
                  className="border border-[#D9D9D9] rounded-2xl shadow-xl p-4"
                >
                  <div className="bg-[#D9D9D9]  p-4 rounded-xl">
                    <div className="flex justify-between pb-2 ">
                      <h1 className="text-black font-bold text-xl pl-25">
                    ...
                    <div className="flex flex-col gap-4 pt-4 text-[#787878]">
                      <h1>
                        ...
                        Description : Join our dynamic team as a Software
                        Engineer, where you will be responsible for developing
                        innovative software solutions and collaborating with
                      ...
                      <h1>
                        ...
                        3+ years of software development experience, proficiency
                        in Java, Python, or C++..{" "}
                      </h1>
                      <h1>
                        <span className="text-black font-bold">
                        ...
                        Communication: The ability to share ideas and feelings,
                        and to listen actively . Problem-solving: The ability to
                        understand and resolve situations
                      </h1>
                      <h1>
                        <span className="text-black font-bold">Benefits :</span>{" "}
                        Health insurance, flexible work hours, opportunities for
                  ...
                  <div className=" pt-4">
                    <a
                      className="bg-[#34A853]  text-white px-4 py-1 rounded-lg"
                      href="#"
                    >
                      Active
                    </a>
