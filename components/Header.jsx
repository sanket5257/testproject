    ...
    <div className="bg-white w-full z-50 absolute">
      <div className=" h-[7vh]  bg-white w-full flex justify-center items-center ">
        <div className="h-full flex items-center justify-start pl-10 w-1/3 ">
          <h1 className="text-2xl font-Montserrat font-light">  <span className="text-blue-600 font-medium"> Textile</span>Voice</h1>
        </div>
        <div className=" h-full flex justify-evenly   items-center  w-1/3">
          <h1>Home</h1>
          <h1>Artical & Blog</h1>
          <h1>community</h1>
          <h1>Exhibitions</h1>
