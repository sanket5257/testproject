  ...
  return (
    <div>
      ...
      <div className=''> 
        ...
        <img className='h-full w-full object-cover' src="../employerimg/employeraccount.jpeg" alt="" />
            ...
            <div className='flex gap-2 pb-2'>
                <img className='size-5' src="../employerimg/user.png" alt="" />
                <h3>Company Profile</h3>
              </div>
                    <div className='flex gap-2 pb-2'>
                <img className='size-5' src="../employerimg/search.png" alt="" />
                <h3>Search Employee</h3>
              </div>
              <div className='flex gap-2 pb-2'>
                <img className='size-5' src="../employerimg/mobile.png" alt="" />
                <h3>Post Jobs</h3>
              </div>
              <div className='flex gap-2 pb-2'>
                <img className='size-5' src="../employerimg/independant.png" alt="" />
                <h3>Active Jobs</h3>
              </div>
              <div className='flex gap-2 pb-2'>
                <img className='size-5' src="../save.svg" alt="" />
                <h3>Deleted Jobs</h3>
              </div>
              <div className='flex gap-2 pb-2'>
                <img className='size-5' src="../employerimg/delete.png" alt="" />
                <h3>Saved Candidate</h3>
              </div>
              <div className='flex gap-2 pb-2'>
                <img className='size-5' src="../employerimg/pending.png" alt="" />
                <h3>Packages</h3>
              </div>
            </div>
